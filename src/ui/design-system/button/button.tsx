...
export const Button = ({size = "medium", variant = "accent", icon, iconTheme = "accent", iconPosition = "right", disabled, isLoading, children}: Props) => {
    let variantStyle: string = "", sizeStyle: string = "", icoSize: number = 0; 
    ...
    return (
        <>
            <button type="button" className={clsx(variantStyle, icoSize, sizeStyle, isLoading && "cursor-wait", "relative")} onClick={() => console.log("clicked")} disabled={disabled}>
